                    ...
                    Case True
                        Select Case pVal.EventType
                            Case SAPbouiCOM.BoEventTypes.et_CLICK, SAPbouiCOM.BoEventTypes.et_KEY_DOWN
                                ...
                                If pVal.ItemUID = "3" And (pVal.ColUID = "U_Currency" Or pVal.ColUID = "U_FCalcu" Or pVal.ColUID = "U_PAmount") And Not blnIsLoad Then
                                    BubbleEvent = False
                                    Exit Sub
                                ElseIf (pVal.ItemUID = "3" And pVal.ColUID = "3" And pVal.Row > 0) And Not blnIsLoad Then
                                    If CDbl(CType(oMatrix.Columns.Item("U_PAmount").Cells.Item(pVal.Row).Specific, SAPbouiCOM.EditText).Value) <> 0 Then
                                        BubbleEvent = False
                                        Exit Sub
                                    End If
                                End If
